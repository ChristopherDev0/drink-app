            ...
            <div v-if="notification.show" class="pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                ...
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <XCircleIcon v-if="notification.error" class="h-6 w-6 text-red-500" aria-hidden="true" />
                        <CheckCircleIcon v-else class="h-6 w-6 text-green-500" aria-hidden="true" />
                    </div>
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                    <p v-if="notification.error" class="text-sm font-medium text-red-500">
                        Notificacion
                    </p>
                    <p v-else class="text-sm font-medium text-green-500">
                        Notificacion
                    </p>
